...
read_file({
  target_file: ".github/Phases/CreativePhase/creative-phase-design-enhanced.instructions.md",
  should_read_entire_file: true
})

# Load advanced design mode visual map
read_file({
  target_file: ".github/visual-maps/design-mode-map-enhanced.instructions.md",
  should_read_entire_file: true
})

# Load enhanced platform-responsive detection
read_file({
  target_file: ".github/Core/platform-responsive-detection-enhanced.instructions.md",
  should_read_entire_file: true
})

# Load atomic design methodology rules
read_file({
  target_file: ".github/Phases/CreativePhase/atomic-design-methodology.instructions.md",
  should_read_entire_file: true
})

# Load advanced accessibility rules
read_file({
  target_file: ".github/Core/accessibility-excellence.instructions.md",
  should_read_entire_file: true
})

# Load design system integration rules
read_file({
  target_file: ".github/Core/design-system-integration.instructions.md",
  should_read_entire_file: true
})
```
