---
tools: ['search/codebase', 'usages', 'fetch', 'search/searchResults', 'edit/editFiles', 'search', 'new', 'runCommands', 'runTasks']
...
graph TD
    ...
    %% Rule Loading
    CheckMB_Van --> LoadVan["Load Rule:<br>visual-maps/van_mode_split/van-mode-map"]
    CheckMB_Plan --> LoadPlan["Load Rule:<br>visual-maps/plan-mode-map"]
    CheckMB_Creative --> LoadCreative["Load Rule:<br>visual-maps/creative-mode-map"]
    CheckMB_Impl --> LoadImpl["Load Rule:<br>visual-maps/implement-mode-map"]
    CheckMB_QA --> LoadQA["Load Rule:<br>visual-maps/qa-mode-map"]
