...
```mermaid
graph TD
    Start["🚀 START PLANNING"] --> ReadTasks["📚 Read tasks.md<br>.github/instructions/isolation_instructions/main.instructions.md"]
    
    %% Complexity Level Determination
    ReadTasks --> CheckLevel{"🧩 Determine<br>Complexity Level"}
    CheckLevel -->|"Level 2"| Level2["📝 LEVEL 2 PLANNING<br>.github/instructions/isolation_instructions/visual-maps/plan-mode-map.md"]
    CheckLevel -->|"Level 3"| Level3["📋 LEVEL 3 PLANNING<br>.github/instructions/isolation_instructions/visual-maps/plan-mode-map.md"]
    CheckLevel -->|"Level 4"| Level4["📊 LEVEL 4 PLANNING<br>.github/instructions/isolation_instructions/visual-maps/plan-mode-map.md"]
...
### Step 1: READ MAIN INSTRUCTION & TASKS
```
read_file({
...
```
read_file({
  target_file: ".github/instructions/isolation_instructions/visual-maps/plan-mode-map.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/isolation_instructions/Level2/task-tracking-basic.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/isolation_instructions/Level3/task-tracking-intermediate.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/isolation_instructions/Level3/planning-comprehensive.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/isolation_instructions/Level4/task-tracking-advanced.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/isolation_instructions/Level4/architectural-planning.md",
  should_read_entire_file: true
})
```
