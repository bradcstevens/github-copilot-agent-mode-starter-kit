...
$files = @(".githubinstructions", "tasks.md", 
...
# Create all required files
touch .githubinstructions tasks.md \
      memory-bank/projectbrief.md \
      memory-bank/productContext.md \
      memory-bank/systemPatterns.md \
...
$requiredFiles = @(".githubinstructions", "tasks.md")
...
5. **One-Pass Verification**: Verify directory structure in a single pass
   ```
   $requiredPaths = @("memory-bank", "docs", "docs\archive", ".github", "tasks.md")
