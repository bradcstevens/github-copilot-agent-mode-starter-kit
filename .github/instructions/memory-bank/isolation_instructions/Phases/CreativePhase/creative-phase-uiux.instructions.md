---
applyTo: "**/creative-phase-uiux.instructions.md"
---
...
Reference the project's `optimized-creative-template.md`. Key evaluation criteria **must** include:
...
* Use the project's `optimized-creative-template.md` for documenting UI/UX decisions.
