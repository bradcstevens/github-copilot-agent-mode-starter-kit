...
- ## 1. Code Organization and Structure
  ...
  - ### Directory Structure
    ...
    - **.github/:** Stores GitHub instruction files if using VSCode IDE.
  ...
  - ### Code Splitting
    ...
    -  If your application handles large datasets or complex queries, consider code splitting:
       -  Split large mapping files into smaller, manageable chunks. Use `@file` directives if using GitHub to include them in the primary instruction file.
