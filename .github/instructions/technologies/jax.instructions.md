...
- **Miscellaneous Divergences from NumPy**: Be aware of differences in type promotion instructions, unsafe type casts, and other corner cases where JAX's behavior may differ from NumPy.
