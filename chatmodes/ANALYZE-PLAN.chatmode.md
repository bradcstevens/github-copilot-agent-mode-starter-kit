...
read_file({
  target_file: ".github/visual-maps/plan-mode-map.instructions.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/Level2/task-tracking-basic.instructions.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/Level3/task-tracking-intermediate.instructions.md",
  should_read_entire_file: true
})
read_file({
  target_file: ".github/Level3/planning-comprehensive.instructions.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/Level4/task-tracking-advanced.instructions.md",
  should_read_entire_file: true
})
read_file({
  target_file: ".github/Level4/architectural-planning.instructions.md",
  should_read_entire_file: true
})
```
