...
```
read_file({
  target_file: ".github/instructions/Core/command-execution.md",
...
```
read_file({
  target_file: ".github/instructions/visual-maps/implement-mode-map.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/Level1/workflow-level1.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/Level2/workflow-level2.md",
  should_read_entire_file: true
})
```
...
```
read_file({
  target_file: ".github/instructions/Phases/Implementation/implementation-phase-reference.md",
  should_read_entire_file: true
})

read_file({
  target_file: ".github/instructions/Level4/phased-implementation.md",
  should_read_entire_file: true
})
```
