...
*   **Project Root:**
    *   `.github/instructions/`: (if using GitHub instructions) stores project-specific instructions. Each instruction should correspond to a specific aspect of the project or library.
